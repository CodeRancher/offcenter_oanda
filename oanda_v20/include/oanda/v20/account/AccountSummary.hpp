...
#ifndef OANDA_V20_ACCOUNT_ACCOUNTSUMMARY_HPP
#define OANDA_V20_ACCOUNT_ACCOUNTSUMMARY_HPP
...
/**
 * @brief A summary representation of a client’s Account.
 *
 * The AccountSummary does not provide to full specification of pending Orders, open Trades and Positions.
...
struct AccountSummary {
	...
	/**
	 * @brief The current guaranteed Stop Loss Order settings of the Account.
	 *
	...
	/**
	 * @brief Client-provided margin rate override for the Account.
	 *
...
#endif /* OANDA_V20_ACCOUNT_ACCOUNTSUMMARY_HPP */
