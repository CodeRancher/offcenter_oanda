...
#ifndef OANDA_V20_ORDER_LIMITORDER_HPP
#define OANDA_V20_ORDER_LIMITORDER_HPP
...
/**
 * @brief A LimitOrder is an order that is created with a price threshold, and will
...
struct LimitOrder {
	...
	/**
	 * @brief The type of the Order. Always set to “LIMIT” for Limit Orders.
	 */
	...
	/**
	 * @brief The quantity requested to be filled by the Limit Order. A positive number
	...
	/**
	 * @brief The price threshold specified for the Limit Order. The Limit Order will
...
#endif /* OANDA_V20_ORDER_LIMITORDER_HPP */
