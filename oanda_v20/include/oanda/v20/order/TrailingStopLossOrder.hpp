...
/**
 * @file   TrailingStopLossOrder.hpp
 * @author Scott Brauer
 *
 * @date   12-07-2020  
 */

#ifndef OANDA_V20_ORDER_TRAILINGSTOPLOSSORDER_HPP
#define OANDA_V20_ORDER_TRAILINGSTOPLOSSORDER_HPP
...
struct TrailingStopLossOrder {
	...
	/**
	 * @brief The type of the Order. Always set to “TRAILING_STOP_LOSS” for Trailing
	 * @brief Stop Loss Orders.
	 */
	...
	/**
	 * @brief The trigger price for the Trailing Stop Loss Order. The trailing stop
	 * @brief value will trail (follow) the market price by the TSL order’s configured
	 * @brief “distance” as the market price moves in the winning direction. If the
	 * @brief market price moves to a level that is equal to or worse than the trailing
	 * @brief stop value, the order will be filled and the Trade will be closed.
	 */
...
#endif /* OANDA_V20_ORDER_TRAILINGSTOPLOSSORDER_HPP */
