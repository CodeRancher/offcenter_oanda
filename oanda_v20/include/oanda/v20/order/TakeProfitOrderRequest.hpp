...
/**
 * @file   TakeProfitOrderRequest.hpp
 * @author Scott Brauer
 *
 * @date   12-07-2020  
 */

#ifndef OANDA_V20_ORDER_TAKEPROFITORDERREQUEST_HPP
#define OANDA_V20_ORDER_TAKEPROFITORDERREQUEST_HPP
...
struct TakeProfitOrderRequest {
	TakeProfitOrderRequest():
		type(oanda::v20::order::OrderType::TAKE_PROFIT),
		timeInForce(oanda::v20::order::TimeInForce::GTC),
		triggerCondition(oanda::v20::order::OrderTriggerCondition::DEFAULT)
	{}

	/**
	 * @brief The type of the Order to Create. Must be set to “TAKE_PROFIT” when
	 * @brief creating a Take Profit Order.
	 */
...
#endif /* OANDA_V20_ORDER_TAKEPROFITORDERREQUEST_HPP */
