...
/**
 * @file   StopLossDetails.hpp
 * @author Scott Brauer
 *
 * @date   12-07-2020  
 */

#ifndef OANDA_V20_TRANSACTION_STOPLOSSDETAILS_HPP
#define OANDA_V20_TRANSACTION_STOPLOSSDETAILS_HPP
...
#endif /* OANDA_V20_TRANSACTION_STOPLOSSDETAILS_HPP */
