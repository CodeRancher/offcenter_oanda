...
/**
 * @file   OrderClientExtensionsModifyRejectTransaction.hpp
 * @author Scott Brauer
 *
 * @date   12-07-2020  
 */

#ifndef OANDA_V20_TRANSACTION_ORDERCLIENTEXTENSIONSMODIFYREJECTTRANSACTION_HPP
#define OANDA_V20_TRANSACTION_ORDERCLIENTEXTENSIONSMODIFYREJECTTRANSACTION_HPP
...
struct OrderClientExtensionsModifyRejectTransaction {
	 ...
	 */
	oanda::v20::transaction::ClientExtensions clientExtensionsModify;

	/**
	 *  The new Client Extensions for the Order’s Trade on fill.
	 */
	oanda::v20::transaction::ClientExtensions tradeClientExtensionsModify;
...
#endif /* OANDA_V20_TRANSACTION_ORDERCLIENTEXTENSIONSMODIFYREJECTTRANSACTION_HPP */
