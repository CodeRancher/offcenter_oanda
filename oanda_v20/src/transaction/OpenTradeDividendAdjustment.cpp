...
/**
 * File: OpenTradeDividendAdjustment.cpp
 * Author: Scott Brauer
 *
...
void to_json(nlohmann::json& j, const OpenTradeDividendAdjustment& p) {
	j = nlohmann::json {
		{"tradeID", p.tradeID},
...
void from_json(const nlohmann::json& j, OpenTradeDividendAdjustment& p) {
	try {
