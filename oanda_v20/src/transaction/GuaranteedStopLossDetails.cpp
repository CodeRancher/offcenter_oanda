...
/**
 * File: GuaranteedStopLossDetails.cpp
 * Author: Scott Brauer
 *
...
void to_json(nlohmann::json& j, const GuaranteedStopLossDetails& p) {
	j = nlohmann::json {
		{"price", p.price},
		{"distance", p.distance},
...
void from_json(const nlohmann::json& j, GuaranteedStopLossDetails& p) {
	try {
