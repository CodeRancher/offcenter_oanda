...
/**
 * File: MarketOrderMarginCloseout.cpp
 * Author: Scott Brauer
 *
...
void to_json(nlohmann::json& j, const MarketOrderMarginCloseout& p) {
	j = nlohmann::json {
		{"reason", p.reason}
	};
}

void from_json(const nlohmann::json& j, MarketOrderMarginCloseout& p) {
	try {
