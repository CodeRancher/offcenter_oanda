...
/**
 * File: MarketOrderPositionCloseout.cpp
 * Author: Scott Brauer
 *
...
void to_json(nlohmann::json& j, const MarketOrderPositionCloseout& p) {
	j = nlohmann::json {
...
void from_json(const nlohmann::json& j, MarketOrderPositionCloseout& p) {
	try {
