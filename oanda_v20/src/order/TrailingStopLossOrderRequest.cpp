...
/**
 * File: TrailingStopLossOrderRequest.cpp
 * Author: Scott Brauer
 *
...
void to_json(nlohmann::json& j, const TrailingStopLossOrderRequest& p) {
	j = nlohmann::json {
		{"type", p.type},
		{"tradeID", p.tradeID},
...
void from_json(const nlohmann::json& j, TrailingStopLossOrderRequest& p) {
	try {
