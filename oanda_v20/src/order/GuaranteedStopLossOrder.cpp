...
/**
 * File: GuaranteedStopLossOrder.cpp
 * Author: Scott Brauer
 *
...
void to_json(nlohmann::json& j, const GuaranteedStopLossOrder& p) {
	j = nlohmann::json {
		{"id", p.id},
...
void from_json(const nlohmann::json& j, GuaranteedStopLossOrder& p) {
	try {
