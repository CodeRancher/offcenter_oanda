...
/**
 * @file   AccountInstrumentsResponse.cpp
 * @author Scott Brauer
 * @date   12-08-2020
 */
...
void to_json(nlohmann::json& j, const AccountInstrumentsResponse& p) {
	j = nlohmann::json {
...
void from_json(const nlohmann::json& j, AccountInstrumentsResponse& p) {
	try {
