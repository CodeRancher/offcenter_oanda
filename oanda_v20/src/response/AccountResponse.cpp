...
void to_json(nlohmann::json& j, const oanda::v20::endpoint::account::AccountResponse& p) {
	j = nlohmann::json {
		{"account", p.account},
...
void from_json(const nlohmann::json& j, oanda::v20::endpoint::account::AccountResponse& p) {
	try {
