...
/**
 * @file   AccountSummaryResponse.cpp
 * @author Scott Brauer
 * @date   12-08-2020
 */
...
void to_json(nlohmann::json& j, const AccountSummaryResponse& p) {
	j = nlohmann::json {
		{"account", p.account},
...
void from_json(const nlohmann::json& j, AccountSummaryResponse& p) {
	try {
